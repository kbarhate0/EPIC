...
public class ExcelRead extends ExcelDriverBridge implements ExcelData {
       ...
       public static String testCaseError, receivedXML, corrid, currTestCaseName,currTestCaseId,currServiceID,currLocalNet;
       ...
       public static void main(String[] args) throws Exception {
              ...
              String executionWorkBook = projectPath + "\\EPIC_ExecutionSheet.xls";
              CommonFunctions2.setPropFile(projectPath + "\\src\\main\\resources\\epicProperties.properties");
              extent = new ExtentReports(projectPath + "/Reports/ITT/EPIC_TestReport.html", true);
                     ...
                     if (currTestSuiteFlag.equalsIgnoreCase("y")) {
                           ...
                           for (int tcSheetIterator = 1; tcSheetIterator < tcSheetRowCount; tcSheetIterator++) {
                                  ...
                                  if (currTestCaseFlag.equalsIgnoreCase("y")
                                         ...
                                         currLocalNet=currTestCaseIP[18];
                                         ...
                                         //     System.out.println(stepType +" , "+ tsSSheetIterator);
                                                       ...
                                                       for (int bpcRowIterator = bpcStartRow - 1; bpcRowIterator < (bpcStartRow + bpcStepCount
                                                              ...
                                                              if (currBPCTestStepExec.equalsIgnoreCase("Y")) {
                                                            	  System.out.println("This is current row  in BPC: " + bpcRowIterator);
                                                                     ...
                                                                     testCasePrint = "none";
                                                                     testCaseStatus ="none";
                                                                     System.out.println(ExcelRead.testCaseStatus +" --------before reusable function-----------------------------------");
                                                                     reusableFunctions(currTestCaseBrowser, currBPCTestStepUDF, currBPCTestStepIP);
                                                                     System.out.println(ExcelRead.testCaseStatus +" --------after reusable function-----------------------------------");
                                                                     if (currBPCTestStepReport.equalsIgnoreCase("Y")) {
                                                                           if (ExcelRead.testCaseStatus.equalsIgnoreCase("fail")) {
                                                                                  test.log(LogStatus.FAIL,
                                                                                                "Test step failed for : " + currBPCTestStepDescription,  test.addScreenCapture(screenshotPath));
                                                                                  ...
                                                                                  if (testCasePrint.equals("none")) {
                                                                                         test.log(LogStatus.PASS,
                                                                                                       "Test step passed for : " + currBPCTestStepDescription,  test.addScreenCapture(screenshotPath));
                                                    	   ...
                                                    	   System.out.println("This is current row : " + tsSSheetIterator);
                                                              ...
                                                              if (currTestStepReport.equalsIgnoreCase("Y")) {
                                                                     if (testCaseStatus.equalsIgnoreCase("fail")) {
                                                                           ...
                                                                           test.log(LogStatus.FAIL, "with error as  : " + testCaseError,  test.addScreenCapture(screenshotPath));
                                                                          ...
                                                                          break;
                                                                           ...
                                                                           if (testCasePrint.equals("none")) {
                                                                                  test.log(LogStatus.PASS,
                                                                                                "Test step passed for : " + currTestStepDescription,  test.addScreenCapture(screenshotPath));
       ...
       public static String retRunTimeVar(String inputParam) {
              ...
              if(inputParam.contains("Difference"))
