...
public class MobileAutomation {
    ...
    public static void main(String[] args)  
    {
    	...
    	try {
    		...
    		capabilities=new MobileAutomation().setCapabilities(dataUsagePackage,dataUsageActivity);    		 
    		...
    		Thread.sleep(5000);
             ...
             capabilities=new MobileAutomation().setCapabilities(youTubePackage,youTubeActivity);
             driver=new AppiumDriver(new URL("http://0.0.0.0:4723/wd/hub"), capabilities);          
             Thread.sleep(10000);
             ...
             capabilities=new MobileAutomation().setCapabilities(epicPackage,epicActivity);
             driver=new AppiumDriver(new URL("http://0.0.0.0:4723/wd/hub"), capabilities);
             Thread.sleep(15000);
             
             new MobileAutomation().clickOnButton(driver,602,1564);
    		 Thread.sleep(10000); 
    		 new MobileAutomation().clickOnButton(driver,1007,1771);
    		 Thread.sleep(10000); 
    		 new MobileAutomation().clickOnButton(driver, 998, 1780);
    		 Thread.sleep(10000);
    		 new MobileAutomation().clickOnButton(driver, 998, 1780);		 
    		 Thread.sleep(10000);
    		 driver.findElement(By.xpath("//android.widget.TextView[@text='thanks, but I will do it later']")).click(); 
    		 Thread.sleep(10000);
    		 new MobileAutomation().clickOnButton(driver, 992, 295);
    		 Thread.sleep(10000);
    	...
    	/*common	
           new MobileAutomation().swipe(driver);
           System.out.println("Before action 2");
           new MobileAutomation().swipe(driver);  
           System.out.println("Before action 3");
    		Thread.sleep(10000);
    		
    		 new MobileAutomation().clickOnButton(driver, 983, 1825);
